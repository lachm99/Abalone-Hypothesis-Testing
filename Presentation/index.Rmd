...
.small[.brand-blue[Excluding `Sex` factor.]]
]
...
.small[.brand-blue[Including `Sex`; utilising dummy-coding to construct a contrast matrix.]]
]
---

.pull-left[## Initial, excluding `sex`.
```{r}
...
.pull-right[## Transformed, including `sex`.
```{r, warning = FALSE}
fn_data = function(data, mapping, ...) {
...
$$
\widehat{\operatorname{sqrt\_log\_rings}} = 1.45 + 0.2(\operatorname{log\_whole}) - 0.19(\operatorname{log\_shucked}) - 0.02(\operatorname{log\_viscera}) + 0.11(\operatorname{log\_shell}) + 0.07(\operatorname{log\_diam}) - 0.08(\operatorname{log\_length}) + 0.12(\operatorname{sqrt\_height}) + 0(\operatorname{sex\_f}) - 0.02(\operatorname{sex\_i}) + \epsilon
$$
